# CEK BARIS 92, 96 & 99, 215 SEBELUM RUN
...
def processATF(excelfile, output_path, now_date):
    ...
    for row in range(start_row + 1, end_row):
        ...
        if any([
            major_equipment.isspace() or not major_equipment or major_equipment == 'None',
            unit_category.isspace() or not unit_category or unit_category == 'None',
            # manufacturing_atf.isspace() or not manufacturing_atf,
            equipment_category_atf.isspace() or not equipment_category_atf or equipment_category_atf == 'None',
            equipment_type_atf.isspace() or not equipment_type_atf or equipment_type_atf == 'None',
        ]):
